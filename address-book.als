...
fun pathState: State { path/pathState }
fun pathSigma: State->State { path/pathSigma }
...
check MC_badSafety for exactly 6 State, exactly 4 PhoneNumber, 6 Path
...
//check MC_badLiveness for exactly 6 State, exactly 4 PhoneNumber, 6 Path
